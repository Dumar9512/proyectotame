...
public class ftrabajador {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        String[] titulos = {"ID", "Nombre", "Apaterno", "Amaterno", "Doc", "Numero Documento", "Dirección", "Telefono", "Email", "Sueldo","Acceso","Login","Clave","Estado"};
    ...
    public boolean insertar(vtrabajador dts) {
        ...
        sSQL2 = "insert into trabajador (idpersona,sueldo,acceso,login,password,estado)"
                + "values ((select idpersona from persona order by idpersona desc limit l),?,?,?,?,?)";
