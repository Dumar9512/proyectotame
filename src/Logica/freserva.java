...
public class freserva {
    ...
    public DefaultTableModel mostrar(String buscar){
        ...
        String [] titulos = {"ID","Idhabitacion","Numero","idcliente","Cliente","idtrabajador","Trabajador","Tipo Reserve","Fecha Reserva","Fecha Ingreso","Fecha Salida","Costo","Estado"};
    ...
    public boolean editar (vreserva dts){
        sSQL="update reserva set idhabitacion=?,idcliente=?,idtrabajador=?,tipo_reserva=?,fecha_reserva=?,feha_ingresa=?,fecha_salida=?,costo_alojamiento=?,estado=?"+
                " where idreserva=?";
